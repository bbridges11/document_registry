...
func validateSemantics(def *PatternSchema) []outbound.ValidationIssue {
...
func validateRelationships(def *PatternSchema) []outbound.ValidationIssue {
	var issues []outbound.ValidationIssue
...
func validateInputReferences(def *PatternSchema) []outbound.ValidationIssue {
	var issues []outbound.ValidationIssue
...
func validateComponentUniqueness(def *PatternSchema) []outbound.ValidationIssue {
	var issues []outbound.ValidationIssue
...
func validateEnumInputs(def *PatternSchema) []outbound.ValidationIssue {
	var issues []outbound.ValidationIssue
...
func validateFileScopeConsistency(def *PatternSchema) []outbound.ValidationIssue {
	var issues []outbound.ValidationIssue
